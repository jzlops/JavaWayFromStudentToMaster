...
public class StubMainOperations {
    /**
     ...
     */
    @Test
    public void showItemByID() throws ParseException {
        SimpleDateFormat simpleDateFormat = new SimpleDateFormat("yyyy.MM.dd HH:mm:ss");
        ...
        ConsoleMainMenu consoleMainMenu = new ConsoleMainMenu(tracker, testInput, testOutput);
        consoleMainMenu.start();
        Assert.assertEquals(tracker.getItemByID("RQS123123"), item);
    ...
    public void showItemByDataRange() throws ParseException {
        SimpleDateFormat simpleDateFormat = new SimpleDateFormat("yyyy.MM.dd HH:mm:ss");
        Item[] item;
        Input testInput = new StubIN(new String[]{"6", "2222.22.22 22:22:21", "2222.22.22 22:22:23", "0"});
        Output testOutput = new StubOUT();
        Tracker tracker = new Tracker(1);
        Item item1 = null;
        try {
